// src/pages/BanquetHalls/Components/AddBanquetHall.jsx
import React, { useState } from 'react';
import { useCreateBanquetHallMutation } from '../../../../services/eventAPI';

const AddBanquetHall = ({ onClose }) => {
  const [createBanquetHall, { isLoading }] = useCreateBanquetHallMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.name || !formData.description || !formData.capacity || !images.length) {
      ...
      // Send request
      await createBanquetHall(formDataToSubmit).unwrap();
      setSuccess('Banquet hall created successfully!');
      
      // Close modal after success
      setTimeout(() => onClose(), 1500);
    } catch (err) {
      setError(err.data?.message || 'Failed to create banquet hall');
    }
  };
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Add New Banquet Hall</h5>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="modal-footer px-0 pb-0">
                  ...
                  <button
                    ...
                    disabled={isLoading}
                  >
                    {isLoading ? 'Creating...' : 'Create Banquet Hall'}
                  </button>
                </div>
              </form>
            </div>
